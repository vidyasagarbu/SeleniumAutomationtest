...
public class ExtentReportsTestCase_Method1 {
	...
	public void startReport() {
		...
		extent.setSystemInfo("IBM ID", "IBMRegressionID");
		
		
		
		htmlReporter.config().setDocumentTitle("IBM Batch2 - Functional Automation/API Report");
		// Name of the report
...
//			logger.fail("Test Case Passed Snapshot is below " + logger.addScreenCaptureFromPath(screenshotPath));
			...
			logger.log(Status.PASS, MarkupHelper.createLabel(result.getName() + " Test Case PASSED", ExtentColor.GREY));
